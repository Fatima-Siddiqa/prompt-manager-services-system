...
export async function executePrompt(promptId, model = null, systemPrompt = null) {
  const body = {}
...
export async function sendFollowUp(chatId, content, model = null, systemPrompt = null) {
  const body = { content }
  if (model) body.model = model
  if (systemPrompt) body.system_prompt = systemPrompt
